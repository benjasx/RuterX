    ...
    <div className="w-full bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex flex-col">
      ...
      <div className="flex gap-2 mb-8 max-w-md">
        <input
          ...
          className="flex-1 border border-slate-300 rounded-lg px-3 py-2 uppercase" // Añadimos 'uppercase' de Tailwind para que el usuario lo vea en mayúsculas al escribir
        />
        <button
