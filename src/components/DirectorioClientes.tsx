      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 shrink-0">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-900/40 hover:border-emerald-300 transition-colors text-sm font-semibold cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-300 border border-red-200 dark:border-red-800 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 hover:border-red-300 transition-colors text-sm font-semibold cursor-pointer"
            title="Generar PDF"
          >
            <FileText size={16} />
            PDF
            ...
            {clientesPaginados.length > 0 ? (
              clientesPaginados.map((cliente) => (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300">
                      {cliente.ruta}
                    </span>
                  </td>
                  ...
                  <td className="py-3 px-4 text-center">
                    ...
                    <button
                      ...
                      className="text-slate-400 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 transition-colors p-2 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-full cursor-pointer disabled:opacity-50"
                      title="Eliminar"
                    >
