        ...
        <div className="lg:col-span-1 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 h-fit sticky top-6">
          <h2 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-5 flex items-center gap-2">
            {editingId ? (
              ...
              <>
                <UserPlus size={18} className="text-blue-600 dark:text-blue-400" /> Nuevo Registro
              </>
            )}
          </h2>
                  ...
                  {choferesPaginados.map((c: any) => {
                    ...
                    >
                      ...
                      <td className="p-4 text-center">
                        <span
                          className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-md tracking-wider ${c.tipo === "Auxiliar" ? "bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-300" : "bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300"}`}
                        >
                          {c.tipo || "Chofer"}
                        </span>
                      </td>
